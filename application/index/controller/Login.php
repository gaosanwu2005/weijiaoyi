...
//            }
    ...
    public function sendmsm()
    {
        ...
        if ($_SESSION['sendtime']&&time() - $_SESSION['sendtime'] < 60) {
            return WPreturn('请60秒后再试！', -1);
        }
        if ($_SESSION['times']&&time() - $_SESSION['times'] >5) {
            return WPreturn('发送频繁！', -1);
        }
